          ...
          <div className="flex gap-4 mt-4 items-start">
            ...
            <div>
              ...
              <p className="text-[13px]">
                Orders placed before 23:59 are shipped the same day. Enjoy free
                shipping on all orders above €150 in the EU.
              </p>
            </div>
          </div>
        ...
        <div className="flex items-center gap-3">
          <div className="flex gap-4 mt-4 items-start">
            ...
            <div>
              ...
              <p className="text-[13px]">
                All orders can be easily returned, or exchanged for a different
                size, color, or model within 14 days, through our return portal.
              </p>
            </div>
          </div>
          <PiCopy className="text-2xl" />
